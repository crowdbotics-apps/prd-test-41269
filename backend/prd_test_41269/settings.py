"""
Django settings for prd_test_41269 project.
...
ROOT_URLCONF = 'prd_test_41269.urls'
...
WSGI_APPLICATION = 'prd_test_41269.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prd_test_41269 API",
    "DESCRIPTION": "API documentation for prd_test_41269 App",
    "VERSION": "v1",
}
